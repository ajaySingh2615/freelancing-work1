...
<!-- Include About Page Specific CSS -->
<link rel="stylesheet" href="assets/css/about-page/about-hero.css">
    ...
    <div class="container story-container">
        ...
        <div class="story-content reverse">
            <div class="story-text">
                <div class="story-text-content">
                    <h3>Our Growth</h3>
                    <p>Over the years, we've expanded our services, partnered with prestigious universities across multiple countries, and developed comprehensive support systems that guide students from application to graduation.</p>
        ...
        <div class="mvv-grid">
            <div class="mvv-card">
                ...
                <p class="mvv-description">
                    To provide comprehensive, ethical, and personalized guidance to students seeking quality medical education abroad, ensuring their academic and professional success.
                </p>
            </div>
            <div class="mvv-card">
                <div class="mvv-icon">
                ...
                <p class="mvv-description">
                    To be the most trusted and preferred global education consultancy, recognized for excellence, integrity, and student success worldwide.
                </p>
            </div>
            <div class="mvv-card">
                <div class="mvv-icon">
                ...
                <p class="mvv-description">
                    Integrity, excellence, student-centricity, transparency, and continuous innovation drive everything we do in our commitment to student success.
                </p>
            </div>
        </div>
    </div>
